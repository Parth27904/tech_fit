...
class Warmup1 extends StatefulWidget {
  const Warmup1({super.key});

  @override
  State<Warmup1> createState() => _Warmup1State();
}

class _Warmup1State extends State<Warmup1> {
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              ...
              image: DecorationImage(
                  fit: BoxFit.fitWidth,
                  image: NetworkImage(
                      'https://www.spotebi.com/wp-content/uploads/2014/10/push-up-exercise-illustration.gif')),
            ),
          ),
          const Text("Push Ups",style: TextStyle(
            fontSize: 23,
