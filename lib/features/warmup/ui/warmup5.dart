...
class Warmup5 extends StatefulWidget {
  const Warmup5({super.key});

  @override
  State<Warmup5> createState() => _Warmup5State();
}

class _Warmup5State extends State<Warmup5> {
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              ...
              image: DecorationImage(
                  fit: BoxFit.fitWidth,
                  image: NetworkImage(
                      'https://www.spotebi.com/wp-content/uploads/2014/10/plank-exercise-illustration.gif')),
            ),
          ),
          const Text("Plank",style: TextStyle(
            fontSize: 23,
