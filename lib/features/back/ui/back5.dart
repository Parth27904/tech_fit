...
class Back5 extends StatefulWidget {
  const Back5({super.key});

  @override
  State<Back5> createState() => _Back5State();
}
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              ...
              image: DecorationImage(
                  fit: BoxFit.fitWidth,
                  image: NetworkImage(
                      'https://www.fitnesschemas.nl/images/CBUprightRow.gif')),
            ),
          ),
          const Text("Cable Upright Row",style: TextStyle(
            fontSize: 23,
